...
public class TurtleRaftBannerLayer extends RenderLayer<TurtleRaftEntity, TurtleRaftModel> {
    ...
    @Override
    public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource source, int packedLight, TurtleRaftEntity entity, float p_117353_, float p_117354_, float p_117355_, float p_117356_, float p_117357_, float p_117358_) {
