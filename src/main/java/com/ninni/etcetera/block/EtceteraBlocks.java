...
public class EtceteraBlocks {
    ...
    public static final Block CRUMBLING_STONE = register("crumbling_stone", new CrumblingStoneBlock(FabricBlockSettings.copyOf(Blocks.STONE).strength(0.5f, 3f).dropsNothing()));
