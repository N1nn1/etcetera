...
public class EtceteraBlocks {
    ...
    public static final Block CRUMBLING_STONE = register("crumbling_stone", new CrumblingStoneBlock(FabricBlockSettings.copyOf(Blocks.STONE).sounds(EtceteraBlockSoundGroups.CRUMBLING_STONE).strength(0.5f, 3f).dropsNothing()));
