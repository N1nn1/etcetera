...
public class EtceteraBlocks {
    ...
    public static final Block MUCUS = register("mucus", new MucusBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.PALE_YELLOW).sounds(BlockSoundGroup.SLIME).nonOpaque()));
