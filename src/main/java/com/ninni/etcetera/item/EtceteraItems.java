...
public class EtceteraItems {
    ...
    public static final Item TIDAL_HELMET = register("tidal_helmet", new ArmorItem(EtceteraArmorMaterials.TIDAL, EquipmentSlot.HEAD, new Item.Settings().rarity(Rarity.UNCOMMON).group(ItemGroup.COMBAT)));
